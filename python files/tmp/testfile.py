...
tau_ot1 = 3.75e-4
tau_ot2 = 9e-4
with open('./QPD_output/data_14-May-2024 13:58:16.txt', 'r') as input:
...
with open('./QPD_output/data_15-May-2024 14:55:24.txt', 'r') as input:
    lines = input.readlines()
    for line in lines[1:-1:step_size]:
        #print(line)
        items =  line.split(',')
...
with open('./QPD_output/data_15-May-2024 10:44:47.txt', 'r') as input:
    lines = input.readlines()
    for line in lines[1:-1:step_size]:
        #print(line)
        items =  line.split(',')
