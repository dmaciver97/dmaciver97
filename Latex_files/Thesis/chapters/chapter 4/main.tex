...
\comment{Do you actually examine aggregates larger than dimers?  If
  not, then just change the title to reflect that you just examine dimers.}
...
\begin{figure}[t]
	...
	\centering
	\includegraphics[width=0.6\linewidth]{tx_different_polarisations.png}
	\end{subfigure}
	\begin{subfigure}{\linewidth}
	\centering
	\includegraphics[width=0.6\linewidth]{ty_different_polarisations.png}
	\end{subfigure}
	\begin{subfigure}{\linewidth}
	\centering
	\includegraphics[width=0.6\linewidth]{tz_different_polarisations.png}
	\end{subfigure}
\caption{Calculation of the optical torque about the three primary axis on a symmetric dimer in linear, elliptical, and circular polarisation beams.}
\end{figure}
\newpage

\comment{It would be good to have a plot of the torque in each of the
  three axes as a function of the polarization of the trapping beam,
  from linearly polarized to elliptically polarized to circularly polarized.}
