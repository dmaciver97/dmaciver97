...
against the direction of beam orientation (see left hand side of figure~\ref{fig:paradigmatic}). 
...
It should be noted that the difference in magnitude is not clearly shown in 
