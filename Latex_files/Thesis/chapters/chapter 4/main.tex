...
Where the ellipticity of the beam is given by $e = (1-\kappa_y/\kappa_x)^{0.5}$ and is a measure of the symmetry of 
...
around 15 \% after a total calibration time of 81 seconds \cite{BergSoerensen2004}. If we now consider a symmetric the 
...
more symmetrical while trapping a symmetric dimer. This 
change can be partially explained by the fact that rotational
