...
nucleus forms at the trap focus, growing quickly until after roughly $6$ seconds 
the crystal escapes the trap. The key take away to remember is that the beam has no 
real influence over the crystal front,instead the crystal grows outward from the 
centre of the focus.
\begin{figure}[h!]
	...
	quickly through (c)-(e) until after $6.665\ s$ the crystal begins to escape the
	trap.}
\end{figure}
...
were observed in which the crystal front follows the path of the laser. See below 
in \textcolor{red}{Fig.XX} where we have the laser focus moving in a small elliptical 
pattern, 